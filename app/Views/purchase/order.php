                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php foreach ($purchase_order_column as $column) : ?>
                                    ...
                                    <?php elseif ($column->name == 'product_price') : ?>
                                        ...
                                        <td style="width: 150px;">
                                            <input readonly class="form-control p-0 px-1 m-0 product_price" type="text" id="qty_<?= $purchase_order['product_price'] ?>" name="<?= "data[$data][$column->name]" ?>" value="<?= ucfirst(str_replace('_', ' ', $purchase_order[$column->name])) ?>">
                                        </td>
                                        <!-- PRODUCT PRICE -->
                                    <?php elseif ($column->name == 'quantity') : ?>
                                ...
                                <!-- SUB TOTAL -->
                                <td style="width: 150px;">
                                    <input readonly class="form-control p-0 px-1 m-0 sub_total" type="number" id="sub_total_<?= $purchase_order['product_id'] ?>" name="<?= "data[$data][sub_total]" ?>" value="<?= $sub_total ?>">
                                </td>

                                <!-- DELETE -->
                                <td class="text-center" style="width: 40px">
                                    <div data-bs-toggle="modal" data-bs-target="#modal_confirm" class="btn p-0 m-0" onclick="return modalConfirm('/purchase-order-delete/<?= $purchase_order['product_id'] ?>')">
