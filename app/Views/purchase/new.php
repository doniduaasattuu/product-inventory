...
<div class="mb-4">
    ...
    <?= view('components/breadcrumb', ['base' => ['link' => '/purchase', 'name' => 'Purchases'], 'action' => 'New']) ?>
</div>

<?php if (isset($purchase_orders) && null != $purchase_orders) : ?>
    <div class="mb-3">
        <div class="btn-group dropend">
            <button type="button" class="btn btn-success">
                <a class="text-white nav-link d-inline-block" aria-current="page" href="/purchase-order">
                    <div>
            ...
            <ul class="dropdown-menu">
                <li>
                    <div style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#modal_confirm" class="px-2" onclick="return modalConfirm('/purchase-order-delete')">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-center" style="width: 40px; cursor: pointer;">
                                <a href="/purchase-order/<?= $product['id'] ?>">
